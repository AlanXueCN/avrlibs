 ...
 * Тип размера данных.
 */
typedef uint8_t one_wire_size_t;
 ...
 * @return Код ошибки.
 */
extern err_t one_wire_init(one_wire_t* ow, uint8_t port_n, uint8_t pin_n);
 ...
 */
extern void one_wire_write(one_wire_t* ow, const void* data, one_wire_size_t size);
 ...
 * @param size Размер данных.
 */
extern void one_wire_read(one_wire_t* ow, void* data, one_wire_size_t size);
 ...
 */
extern uint8_t one_wire_calc_crc(const void* data, one_wire_size_t size);
